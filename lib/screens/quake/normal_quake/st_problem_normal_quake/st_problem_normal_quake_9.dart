...
class St_problem_normal_quake9 extends StatefulWidget {
  const St_problem_normal_quake9({super.key});

  @override
  State<St_problem_normal_quake9> createState() =>
      _St_problem_normal_quake9State();
}
                ...
                Center(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      context.go(RoutePaths.st_pro_normal_quake10);
                    },
                    child: Text('次の問題へ'),
                  ),
                )
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/土石流警戒.png'),
                      fit: BoxFit.contain,
                    ),
                    boxShadow: [
                      BoxShadow(
