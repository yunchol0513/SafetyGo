...
class St_problem_normal_quake14 extends StatefulWidget {
  const St_problem_normal_quake14({super.key});

  @override
  State<St_problem_normal_quake14> createState() =>
      _St_problem_normal_quake14State();
}

class _St_problem_normal_quake14State extends State<St_problem_normal_quake14> {
  late final AudioPlayer _audioPlayer;
  final List<String> options = ['A津波の時に避難できる安全なビル', 'Bとにかく早く走る', 'C津波が起きた時にはこのビルは安全ではない'];
  final String explanation = "これは選択肢の解説です。正解は A です。このマークがある場合は避難できます。";
                ...
                Center(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      context.go(RoutePaths.st_pro_normal_quake15);
                    },
                    child: Text('次の問題へ'),
                  ),
                )
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                      image: AssetImage('assets/images/避難経路.png'),
                      fit: BoxFit.contain,
                    ),
                    boxShadow: [
                      BoxShadow(
