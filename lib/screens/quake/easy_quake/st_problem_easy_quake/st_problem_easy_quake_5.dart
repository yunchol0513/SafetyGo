...
class _StProblemEasyQuake5State extends State<St_pro_easy_quake5> {
  final List<Quiz_3> eazyquizList = [
    ...
    Quiz_3(question: '地震のとき、机の下に隠れるのは安全である。', correctAnswer: '〇', explanation: '揺れが収まるまでは、倒れにくい家具の下に隠れて頭を守ることが基本です。'),
    Quiz_3(question: '家の外に出たら、電柱の近くに立つと安全である。', correctAnswer: '×', explanation: '電柱は倒れたり、電線が切れて落ちたりする危険があるため近づかないようにします。'),
    Quiz_3(question: '避難するときは、靴を履くのがよい。', correctAnswer: '〇', explanation: 'ガラスの破片や瓦礫から足を守るために靴を履いて避難します。'),
    Quiz_3(question: '地震の後は火を使わないようにする。', correctAnswer: '〇', explanation: 'ガス漏れの可能性があるため、火を使わないようにしましょう。'),
    Quiz_3(question: '地震のときはエレベーターで避難する。', correctAnswer: '×', explanation: '停電や閉じ込めの危険があるためエレベーターは使わず階段を使いましょう。'),
    Quiz_3(question: '学校では先生の指示に従うのがよい。', correctAnswer: '〇', explanation: '落ち着いて先生の指示を聞き、安全に避難することが大切です。'),
    Quiz_3(question: '窓のそばは地震のときに安全な場所である。', correctAnswer: '×', explanation: 'ガラスが割れて飛んでくる危険があるため、窓から離れましょう。'),
    Quiz_3(question: '地震のとき、ブロック塀の近くを歩いてよい。', correctAnswer: '×', explanation: '倒れてくる危険があるのでブロック塀からは離れましょう。'),
    Quiz_3(question: '地震が来たらまず119番に電話するのがよい。', correctAnswer: '×', explanation: '緊急時以外は電話が集中するため、安易な通報は避けましょう。'),
