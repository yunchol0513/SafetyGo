...
class Sce1s8 extends StatefulWidget {
  const Sce1s8({super.key});

  @override
  State<Sce1s8> createState() => _Sce1s8State();
}

class _Sce1s8State extends State<Sce1s8> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      /*appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-8')),
        actions: [
          IconButton(
