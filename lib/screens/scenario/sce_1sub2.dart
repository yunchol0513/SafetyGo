...
class Sce1s2 extends StatefulWidget {
  const Sce1s2({super.key});

  @override
  State<Sce1s2> createState() => _Sce1s2State();
}

class _Sce1s2State extends State<Sce1s2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-2')),
        actions: [
          IconButton(
                    ...
                    Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          Text('人２'),
                          SizedBox(height: 8),
                          Text('中学校の防災訓練で「神戸生田中学校」が避難所だって聞いたよ'),
                        ],
                      ),
                    ),
