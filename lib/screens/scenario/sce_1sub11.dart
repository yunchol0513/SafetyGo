...
class Sce1s11 extends StatefulWidget {
  const Sce1s11({super.key});

  @override
  State<Sce1s11> createState() => _Sce1s11State();
}

class _Sce1s11State extends State<Sce1s11> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-11')),
        actions: [
          IconButton(
      ...
      body: Stack(
        children: [
          ...
          //           children: [
          //             ElevatedButton(
          //               onPressed: () => flg.toggleFlg(7),
          //               child: const Text('Toggle flg7'),
          //             ),
