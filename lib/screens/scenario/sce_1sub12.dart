...
class Sce1s12 extends StatefulWidget {
  const Sce1s12({super.key});

  @override
  State<Sce1s12> createState() => _Sce1s12State();
}

class _Sce1s12State extends State<Sce1s12> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-12')),
        actions: [
          IconButton(
      ...
      body: Stack(
        children: [
          ...
          //           children: [
          //             ElevatedButton(
          //               onPressed: () => flg.toggleFlg(6),
          //               child: const Text('Toggle flg6'),
          //             ),
