                    ...
                    Align(
                      ...
                      child: Row(
                        ...
                        children: [
                          //左のキャラクター
                          GestureDetector(
                            onTap: () => context.push(RoutePaths.sce1s2),
                            child: SizedBox(
                              height: 130,
                          ...
                          //右のキャラクター
                          GestureDetector(
                            onTap: () => context.push(RoutePaths.sce1s3),
                            child: SizedBox(
                              height: 130,
...
//                     children: [
//                       ElevatedButton(
//                         onPressed: () => context.push(RoutePaths.sce1s2),
//                         child: const Text('Go To 1s2'),
//                       ),
//                       const SizedBox(width: 16),
//                       ElevatedButton(
//                         onPressed: () => context.push(RoutePaths.sce1s3),
//                         child: const Text('Go To 1s3'),
//                       ),
//                       const SizedBox(width: 16),
//                       // ElevatedButton(
...
//                   child: ElevatedButton(
//                     onPressed: () => context.push(RoutePaths.sce1_4),
//                     child: const Text('Go to 1-4'),
//                   ),
//                 ),
//               ),
//             ],
