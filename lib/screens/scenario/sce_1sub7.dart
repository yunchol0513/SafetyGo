...
class Sce1s7 extends StatefulWidget {
  const Sce1s7({super.key});

  @override
  State<Sce1s7> createState() => _Sce1s7State();
}

class _Sce1s7State extends State<Sce1s7> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-7')),
        actions: [
          IconButton(
      ...
      body: Stack(
        children: [
                    ...
                    Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          Text('人７'),
                          SizedBox(height: 8),
                          Text('この前の地震でも被害がなかったね。どこにもいかないでいいかな'),
                        ],
                      ),
                    ),
          ...
          //           children: [
          //             ElevatedButton(
          //               onPressed: () => flg.toggleFlg(4),
          //               child: const Text('Toggle flg4'),
          //             ),
