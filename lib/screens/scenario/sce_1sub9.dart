...
class Sce1s9 extends StatefulWidget {
  const Sce1s9({super.key});

  @override
  State<Sce1s9> createState() => _Sce1s9State();
}

class _Sce1s9State extends State<Sce1s9> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-9')),
        actions: [
          IconButton(
      ...
      body: Stack(
        children: [
          ...
          //           children: [
          //             ElevatedButton(
          //               onPressed: () => flg.toggleFlg(5),
          //               child: const Text('Toggle flg5'),
          //             ),
