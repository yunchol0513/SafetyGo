...
import 'package:safety_go/constants/route_paths.dart'; // ← ルート定義
import 'sce_2_5.dart';
import 'sce_1_1.dart';
import 'sce_3_1.dart';
 // ステージ2の遷移先
...
class _SceHomeState extends State<SceHome> with SingleTickerProviderStateMixin {
  ...
  void _enterStage() {
    if (currentStage == 1) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const Sce_3_1()), // ステージ2はMaterialPageRouteで遷移
      );
      
    }else if (currentStage == 2) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const Sce_2_5()), // ステージ2はMaterialPageRouteで遷移
      );
      
    }else if (currentStage == 3) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const Sce1_1()), // ステージ2はMaterialPageRouteで遷移
      );
            ...
            child: Padding(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor:
                      isEnterEnabled ? Colors.deepOrange : Colors.grey.shade500,
                  padding:
