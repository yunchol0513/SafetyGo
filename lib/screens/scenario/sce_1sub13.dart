...
class Sce1s13 extends StatefulWidget {
  const Sce1s13({super.key});

  @override
  State<Sce1s13> createState() => _Sce1s13State();
}

class _Sce1s13State extends State<Sce1s13> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-13')),
        actions: [
          IconButton(
      ...
      body: Stack(
        children: [
                    ...
                    Container(
                      ...
                      child: const Column(
                        ...
                        children: [
                          Text('人１３'),
                          SizedBox(height: 8),
                          Text('駅の向こうに「中学校」があるよ！そこは津波でも大丈夫だよ'),
                        ],
                      ),
                    ),
          ...
          //           children: [
          //             ElevatedButton(
          //               onPressed: () => flg.toggleFlg(8),
          //               child: const Text('Toggle flg8'),
          //             ),
