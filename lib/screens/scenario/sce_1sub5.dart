...
class Sce1s5 extends StatefulWidget {
  const Sce1s5({super.key});

  @override
  State<Sce1s5> createState() => _Sce1s5State();
}

class _Sce1s5State extends State<Sce1s5> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      /*appBar: AppBar(
        ...
        elevation: 0,
        title: const Center(child: Text('Scenario sub 1-5')),
        actions: [
          IconButton(
                  ...
                  child: Stack(
                    children: [
                      Align(
                        ...
                        child: SizedBox(
                          height: 400,
                          child: Image.asset('assets/images/hito5.png'),
                        ),
                      ),
                    ],
                  ),
